...
- **[[Prototype]]** | **프로토타입 링크**
  ...
  [[Prototype]]은 보이지 않는 속성으로 **\_\_proto\_\_** 라는 속성으로 참조할 수는 있지만 비표준 속성이며 모든 브라우저에서 지원하는 것이 아니기 때문에 실제로 사용하지 않는 것을 추천드립니다.
...
(수정) 마지막에 있는 anotherObject는 myObject로 생각한다.<br>
