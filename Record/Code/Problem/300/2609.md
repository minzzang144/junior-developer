...
최대공약수를 구하는 가장 쉬운 방법은 2부터 두 수 중 작은 수까지 최대공약수와 최소공배수(2609)
...
유클리드 호제법에서 최대공약수를 GCD라고 했을 때, a와 b의 최대공약수 GCD(a, b)는 a를 b로 나눈 나머지 최대공약수와 최소공배수(2609)
...
최소공배수는 두 수의 공통된 배수 중에서 가장 작은 정수를 말하며 최대공약수를 구할 수 있다면 쉽게 구할 수 있다.<br>
